...
interface InterestItem {
  receiverBiodata: receiverBiodata;
}
...
const InterestCard: React.FC<InterestCardProps> = ({ interest }) => {
  const { receiverBiodata } = interest;
  const { name, age, gender, address, _id } = receiverBiodata;
  const presentAddress = address?.present;
  console.log(interest);

  return (
    <Card className="group hover:shadow-lg transition-all duration-300 border-emerald-100 dark:border-emerald-900/30 hover:border-emerald-300 dark:hover:border-emerald-700/50 bg-gradient-to-br from-white to-emerald-50/30 dark:from-gray-900 dark:to-emerald-950/20">
